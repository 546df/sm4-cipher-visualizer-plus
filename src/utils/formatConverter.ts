 ...
 * @param encoding Character encoding (utf8 or ascii)
 * @returns Array of bytes
 */
export const stringToBytes = (str: string, encoding: 'utf8' | 'ascii' = 'utf8'): number[] => {
  const bytes: number[] = [];
 ...
 */
export const bytesToString = (bytes: number[], encoding: 'utf8' | 'ascii' = 'utf8'): string => {
  if (encoding === 'ascii') {
 ...
 * @param hex Hexadecimal string (without 0x prefix)
 * @returns Array of bytes
 */
 ...
 */
export const bytesToHex = (bytes: number[], uppercase: boolean = false): string => {
 ...
 * @param words Array of 32-bit integers
 * @returns Array of bytes
 */
export const wordsToBytes = (words: number[]): number[] => {
  const bytes: number[] = [];
 ...
 */
export const bytesToWords = (bytes: number[]): number[] => {
  const words: number[] = [];
